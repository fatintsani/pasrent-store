  ...
  return (
    <div className="w-full mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Edit Tipe Konsol: {consoleType.name}</h1>
          <p className="text-muted-foreground text-sm mt-1">Perbarui profil tipe konsol.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input 
            name="image_url" 
            defaultValue={consoleType.image_url || ""}
