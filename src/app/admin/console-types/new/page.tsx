  ...
  return (
    <div className="p-4 md:p-8 w-full mx-auto space-y-6">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">Tambah Tipe Konsol</h1>
          <p className="text-muted-foreground mt-1">Buat profil tipe konsol baru untuk ditampilkan di halaman pelanggan.</p>
        </div>
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 p-6 bg-gray-50 dark:bg-gray-900 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl">
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-xs text-gray-500">Format: JPG, PNG. Ukuran ideal: 800x800px (Rasio 1:1).</p>
            </div>
          </div>
        </div>
