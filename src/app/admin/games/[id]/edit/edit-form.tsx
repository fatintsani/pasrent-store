            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" name="supported_consoles" value="PS3" defaultChecked={supportedConsoles.includes("PS3")} className="w-4 h-4 text-[#5000ef] rounded border-gray-300" />
                  <span className="font-medium">PlayStation 3 (PS3)</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" name="supported_consoles" value="PS4" defaultChecked={supportedConsoles.includes("PS4")} className="w-4 h-4 text-[#5000ef] rounded border-gray-300" />
