...
export default function UnitActions({ id }: { id: string }) {
  ...
  return (
    <div className="flex items-center justify-end gap-2">
      <Link href={`/admin/units/${id}/edit`} className="p-2 text-gray-400 hover:text-[#5000ef] dark:hover:text-[#00c3cb] transition">
