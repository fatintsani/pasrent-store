...
import { updateUnit } from "@/app/actions/admin/units";
...
export default function EditUnitForm({ unit }: { unit: any }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (res.success) {
      ...
      setErrorMsg(res.error || "Gagal menyimpan perubahan unit.");
      setLoading(false);
    }
  }
  ...
  return (
    <div className="p-4 md:p-8 w-full mx-auto space-y-6">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">Edit Unit</h1>
          <p className="text-muted-foreground mt-1">Perbarui detail spesifikasi fisik unit konsol Anda.</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select
                ...
                defaultValue={unit.console_type_id}
