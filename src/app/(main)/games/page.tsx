...
export const metadata: Metadata = {
  ...
  description: "Daftar lengkap game PS3 dan PS4 yang tersedia untuk dirental di Pasrent Store.",
};
...
export default async function GamesPage() {
  ...
  return (
    <main className="min-h-screen pt-24 pb-20 bg-white dark:bg-[#0d0e11] transition-colors duration-300">
      <section className="px-4 py-16 relative transition-colors duration-300">
        ...
        <div className="h-full mx-auto max-w-7xl relative z-10">
          <div className="text-center pb-12">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-gray-900 dark:text-white">
              Katalog <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5000ef] to-[#00c3cb]">Game Lengkap</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mt-6 max-w-2xl mx-auto text-lg">
              Ratusan pilihan game terbaik untuk PS3 dan PS4. Pilih game favoritmu, tambahkan ke keranjang, dan nikmati pengalaman bermain tanpa batas.
            </p>
          </div>
